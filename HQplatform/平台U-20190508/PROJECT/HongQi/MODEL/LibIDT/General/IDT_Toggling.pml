...
<Rect left="382" top="944" right="482" bottom="976"/>
<Script></Script></End>
<Activities>
<Activity id="3" ActivityType="3" flags="0" name="判断通讯端口有效">
...
<Activity id="4" ActivityType="4" flags="0" name="路由节点">
<Rect left="664" top="156" right="696" bottom="188"/>
</Activity>
<Activity id="5" ActivityType="3" flags="0" name="获取ToggleCounter">
...
<Activity id="6" ActivityType="3" flags="0" name="获取上一次发送报文">
...
<Activity id="7" ActivityType="3" flags="0" name="初始化toggle报文">
<Rect left="386" top="469" right="486" bottom="501"/>
<Script>toggleTel = lastSndTel;</Script></Activity>
<Activity id="10" ActivityType="13" flags="0" name="Service字节使用00">
...
<Activity id="12" ActivityType="3" flags="1" name="设置togglebyte">
...
<Activity id="17" ActivityType="3" flags="0" name="检测退出标识">
...
<Rect left="664" top="944" right="696" bottom="976"/>
</Activity>
<Activity id="19" ActivityType="3" flags="0" name="Deay">
<Rect left="90" top="444" right="190" bottom="476"/>
<Script>engine.Delay(31);</Script></Activity>
<Activity id="20" ActivityType="13" flags="0" name="idtToggleDataExchange">
...
<Activity id="21" ActivityType="3" flags="0" name="互斥锁定IDT_GENERAL_SEMAPHORE">
...
<Activity id="22" ActivityType="3" flags="0" name="互斥解锁IDT_GENERAL_SEMAPHORE">
...
<Activity id="23" ActivityType="3" flags="0" name="DEBUG Into Toggle">
<Rect left="386" top="94" right="486" bottom="126"/>
<Script>engine.println("### Start Toggling ...");
toggleStepXcount = 0             -- 同步错位计数</Script></Activity>
<Activity id="24" ActivityType="3" flags="0" name="ToggleFinished">
<Rect left="382" top="864" right="482" bottom="896"/>
<Script>engine.println("### Stop toggling");</Script></Activity>
<Activity id="25" ActivityType="3" flags="0" name="获取上一次发送报文">
...
<Activity id="26" ActivityType="3" flags="0" name="检测退出标识">
<Rect left="540" top="664" right="640" bottom="696"/>
<Script>QUITE = engine.UdpHandleVarGet(pHndl, "_FINISHFLAG");
if nil == QUITE then
    QUITE = false;
end</Script></Activity>
<Activity id="27" ActivityType="3" flags="0" name="同步监测">
...
<Expression>engine.UdpHandleVarGet(pHndl, "_FINISHFLAG") == true</Expression></Transition>
...
<Expression>QUITE == false</Expression></Transition>
<Transition StartId="26" EndId="32" type="0">
</Transition>
...
<Transition StartId="32" EndId="28" type="0">
</Transition>
</Transitions>
</Process>
