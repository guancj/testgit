...
<Variable id="StopFlag" type="3" dir="0" data="0" description="0:没有其他检测,1有其他检测"/>
</Parameters>
...
<Activities>
<Activity id="4" ActivityType="13" flags="0" name="IDT_SERVICE_5_检测循环">
<Rect left="300" top="274" right="400" bottom="306"/>
<Line2Text Enable="1" Text="下一项检测判断"/>
...
<Script>isOK = true;
engine.LastError = 0
engine.StatValue = "05 Service is successful"
engine.println(" &lt;BAS_05_Stop&gt; ")</Script><assessment no="2" name="DEP2325" type="8" flags="97"/>
</Activity>
...
engine.LastError = 1
engine.StatValue = "05 Service is failuer"
...
<Activity id="52" ActivityType="3" flags="0" name="结束设置">
<Rect left="300" top="214" right="400" bottom="246"/>
<Script>if (StopFlag == 1) then                      --有其他检测
	idt_tel = LibIDT.idtSetBytes(idt_tel,3,1,string.char(0x01))
else
	idt_tel = LibIDT.idtSetBytes(idt_tel,3,1,string.char(0x00))
end

print("StopFlag = "..tostring(StopFlag));
</Script></Activity>
<Activity id="53" ActivityType="13" flags="0" name="idtCommonSend">
<Rect left="300" top="164" right="400" bottom="196"/>
...
<Transition StartId="48" EndId="53" type="1">
