...
<Activity id="4" ActivityType="13" flags="0" name="IDT_17_ IFC_Test_Done">
<Rect left="300" top="214" right="400" bottom="246"/>
<Line2Text Enable="1" Text="发送BSD标定结果"/>
...
<Script>isOK = true;
engine.LastError = 0
engine.StatValue = "17 Service is successful"
engine.println(" &lt;IFC done&gt; ")</Script><assessment no="6" name="DEP2329" type="8" flags="97"/>
</Activity>
...
engine.LastError = 1
engine.StatValue = "17 Service is failuer"
engine.DialogBackColor = "red"
engine.Delay(2000)</Script><assessment no="6" name="DEP2329" type="8" flags="97"/>
</Activity>
...
<Activity id="52" ActivityType="3" flags="1" name="服务数据">
<Rect left="140" top="154" right="240" bottom="186"/>
<Script>local BSDret = engine.SharedVarGet("BSDret")
print("BBK_BSDresult:"..BSDret)
if (BSDret == 2) then
	ServiceData = "@2==0b00010001@3==0b00000001"
elseif (BSDret == 3)then
	ServiceData = "@2==0b00010001@3==0b00000000"
else
	ServiceData = "@2==0b00010001@3==0b00000000"
end</Script></Activity>
</Activities>
