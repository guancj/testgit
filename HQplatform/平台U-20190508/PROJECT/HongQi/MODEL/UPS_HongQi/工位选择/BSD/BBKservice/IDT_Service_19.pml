...
<Rect left="300" top="44" right="400" bottom="76"/>
<Script></Script></Start>
...
<Parameter id="BitOrByte" value="&quot;@2==0b00010011@21==0b00000110@22==0b00001110&quot;"/>
<Parameter id="Byte"/>
<Parameter id="String"/>
...
<Activity id="4" ActivityType="13" flags="0" name="IDT_19_ IFC_Test_Done">
<Rect left="300" top="214" right="400" bottom="246"/>
<Line2Text Enable="1" Text="前标定板位置设置"/>
...
<Script>isOK = true;
engine.LastError = 0
engine.StatValue = "19 Service is successful"
engine.println(" &lt;IFC done&gt; ")</Script><assessment no="5" name="DEP2331" type="8" flags="97"/>
</Activity>
...
engine.LastError = 1
engine.StatValue = "19 Service is failuer"
engine.DialogBackColor = "red"
engine.Delay(2000)</Script><assessment no="5" name="DEP2331" type="8" flags="97"/>
</Activity>
