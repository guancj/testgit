...
<Rect left="670" top="764" right="770" bottom="796"/>
<Script></Script></End>
<Activities>
<Activity id="3" ActivityType="3" flags="0" name="按右前门窗点动上升">
<Rect left="670" top="44" right="770" bottom="76"/>
<Line1Text Enable="1"/>
<Line2Text Enable="1" Text="按右前门窗点动上升"/>
<Line3Text Enable="1"/>
<Line4Text Enable="1"/>
<Script>Pram_1 =nil;</Script></Activity>
<Activity id="965" ActivityType="13" flags="0" name="Read_status">
<Rect left="670" top="104" right="770" bottom="136"/>
...
<Rect left="670" top="224" right="770" bottom="256"/>
...
<assessment block="1" ptbtext="DEP164" group="2807" pbltext="DEP2275" no="3" name="DEP2033" type="8" flags="97"/>
</Activity>
<Activity id="971" ActivityType="3" flags="0" name="按右前门窗连续上升">
<Rect left="670" top="344" right="770" bottom="376"/>
<Line1Text Enable="1"/>
<Line2Text Enable="1" Text="按右前门窗连续上升（升到顶）"/>
<Line3Text Enable="1"/>
<Line4Text Enable="1"/>
<Script>Pram_1 =nil;</Script></Activity>
...
<Rect left="854" top="584" right="886" bottom="616"/>
</Activity>
<Activity id="975" ActivityType="4" flags="0" name="路由节点">
<Rect left="854" top="404" right="886" bottom="436"/>
</Activity>
...
<assessment block="1" ptbtext="DEP164" group="2807" pbltext="DEP2275" no="4" name="DEP2034" type="8" flags="97"/>
</Activity>
<Activity id="978" ActivityType="3" flags="0" name="按右前门窗点动下降">
<Rect left="220" top="74" right="320" bottom="106"/>
<Line1Text Enable="1"/>
<Line2Text Enable="1" Text="按右前门窗点动下降"/>
<Line3Text Enable="1"/>
<Line4Text Enable="1"/>
<Script>Pram_1 =nil;</Script></Activity>
...
<assessment block="1" ptbtext="DEP164" group="2807" pbltext="DEP2275" no="1" name="DEP2035" type="8" flags="97"/>
</Activity>
<Activity id="985" ActivityType="3" flags="0" name="按右前门窗连续下降">
<Rect left="220" top="374" right="320" bottom="406"/>
<Line1Text Enable="1"/>
<Line2Text Enable="1" Text="按右前门窗连续下降"/>
<Line3Text Enable="1"/>
<Line4Text Enable="1"/>
<Script>Pram_1 =nil;</Script></Activity>
...
<assessment block="1" ptbtext="DEP164" group="2807" pbltext="DEP2275" no="2" name="DEP2036" type="8" flags="97"/>
</Activity>
<Activity id="992" ActivityType="3" flags="0" name="将玻璃上升">
<Rect left="670" top="644" right="770" bottom="676"/>
...
<Script>engine.SetLineText(2,"#L=请将右前玻璃升到顶".."#R=bmpeye")
#PRESSBUTTON</Script></Activity>
<Activity id="993" ActivityType="3" flags="0" name="状态判断">
<Rect left="670" top="704" right="770" bottom="736"/>
...
engine.LastError = 0;
engine.StatValue ="右前门玻璃已升到顶部"
end</Script><assessment block="1" ptbtext="DEP164" group="3019" pbltext="DEP113" no="36" name="DEP2045" type="8" flags="97"/>
</Activity>
</Activities>
<Transitions>
