...
<Rect left="670" top="1004" right="770" bottom="1036"/>
<Script>--关闭电流
...
<Script>
val_val = math.abs(engine.passenger_front_airbag/engine.constant_current_output);
--val_val=tostring(val_val);
engine.println("driver_front_airbag:"..tostring(engine.driver_front_airbag));
engine.println("constant_current_output:"..tostring(engine.constant_current_output));</Script></Activity>
...
<Rect left="670" top="914" right="770" bottom="946"/>
<TitleText Enable="1"/>
<Line1Text Enable="1"/>
<Line2Text Enable="1"/>
<Line3Text Enable="1"/>
...
<Expression>FinishFlag_1 ==  false</Expression></Transition>
<Transition StartId="897" EndId="913" type="0">
</Transition>
...
<Transition StartId="903" EndId="902" type="0">
</Transition>
