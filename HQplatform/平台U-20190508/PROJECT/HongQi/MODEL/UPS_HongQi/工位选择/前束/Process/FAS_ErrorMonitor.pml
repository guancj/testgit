...
<Rect left="278" top="256" right="378" bottom="288"/>
<Script></Script></End>
<Activities>
...
<Activity id="7" ActivityType="3" flags="0" name="ErrorMonitor_Nok">
<Rect left="280" top="174" right="380" bottom="206"/>
<Script>if (isOK == false) then
	print("Quit FAS ErrorMonitor  isOK false")
...
if(engine.SharedVarGet("_ProcessOK") == 1)then
	...
	print("Quit FAS ErrorMonitor _FINISHFLAG true")
end
 
 </Script><assessment no="7" name="DEP1291" type="8" flags="97"/>
</Activity>
</Activities>
<Transitions>
