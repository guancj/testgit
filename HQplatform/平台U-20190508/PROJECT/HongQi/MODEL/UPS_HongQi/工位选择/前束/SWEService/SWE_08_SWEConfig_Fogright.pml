...
<Variable id="lampType" type="8" dir="0" data=""/>
...
<Script>if (lampType == "Lowbeam_left") then
	serviceData = "@2==0b00001000@24==0b00000001@25==0b00000001@26==0b00000000@27==0b00000000@30==0b00000000"   --左近光灯调整
end

if (lampType == "Hightbeam_left") then
	serviceData = "@2==0b00001000@24==0b00000010@25==0b00000001@26==0b00000000@27==0b00000000@30==0b00000000"   --左远光灯调整
end

if (lampType == "Foglamp_left") then
	serviceData = "@2==0b00001000@24==0b00000100@25==0b00000001@26==0b00000000@27==0b00000000@30==0b00000000"   --左雾灯调整
end

if (lampType == "Infrared_left") then
	serviceData = "@2==0b00001000@24==0b00001000@25==0b00000001@26==0b00000000@27==0b00000000@30==0b00000000"   --左红外光调整
end


if (lampType == "Lowbeam_Right") then
	serviceData = "@2==0b00001000@24==0b00010000@25==0b00000001@26==0b00000000@27==0b00000000@30==0b00000000"   --右近光灯调整
end

if (lampType == "Hightbeam_Right") then
	serviceData = "@2==0b00001000@24==0b00100000@25==0b00000001@26==0b00000000@27==0b00000000@30==0b00000000"   --右远光灯调整
end

if (lampType == "Foglamp_Right") then
	serviceData = "@2==0b00001000@24==0b01000000@25==0b00000001@26==0b00000000@27==0b00000000@30==0b00000000"   --右雾灯调整
end

if (lampType == "Infrared_Right") then
	serviceData = "@2==0b00001000@24==0b10000000@25==0b00000001@26==0b00000000@27==0b00000000@30==0b00000000"   --右红外光调整
end


if (lampType == "Matrix_Left") then
	serviceData = "@2==0b00001000@24==0b00000000@25==0b00000101@26==0b00000000@27==0b00000000@30==0b00000000"   --左矩阵大灯调整
end

if (lampType == "Matrix_Right") then
	serviceData = "@2==0b00001000@24==0b00000000@25==0b00001001@26==0b00000000@27==0b00000000@30==0b00000000"   --右矩阵大灯调整
end</Script></Activity>
</Activities>
<Transitions>
