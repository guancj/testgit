...
<Parameter id="BitOrByte" value="&quot;@2==0b00011010&quot;"/>
<Parameter id="Byte"/>
<Parameter id="String"/>
...
<Activity id="51" ActivityType="13" flags="1" name="FWE_26_Castor">
<Rect left="380" top="274" right="480" bottom="306"/>
<Line2Text Enable="1" Text="26 服务"/>
<Line4Text Enable="1"/>
...
<Script>	isOK = false;
	engine.LastError = 1
        engine.StatValue = "FWE Castor"
	engine.SetLineText(1,"FWE SERVICE 26 ERROR")
	engine.DialogBackColor = "red";
	engine.Delay(2000)
	engine.DialogBackColor = -1;

	engine.println(" &lt;FWE_26_Castor_Err&gt; @Dpin ")</Script></Activity>
</Activities>
<Transitions>
