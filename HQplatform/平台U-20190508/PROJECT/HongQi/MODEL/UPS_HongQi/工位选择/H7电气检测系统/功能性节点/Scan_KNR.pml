...
engine.ListAddString("CH1GM40",false);
engine.ListAddString("CH1AM46",false);
engine.ListAddString("CH1AM47",false);
...
engine.ListAddString("CH1AM54",false);
engine.ListAddString("CH1GM30",false);
engine.ListAddString("CH1GM23",false);
engine.ListAddString("CH1AM43",false);
engine.ListAddString("CH1AM44",false);
engine.ListAddString("CH1BM34",false);
engine.ListAddString("CH1CM31",false);
engine.ListAddString("CH1DM16",false);
engine.ListAddString("CH1DM17",false);
engine.ListAddString("CH1FM20",false);
engine.ListAddString("CH1FM30",false);
engine.ListAddString("CH1NM11",false);
engine.ListAddString("CH1JM12",false);
...
<Activity id="3" ActivityType="3" flags="1" name="提示扫码">
...
<Expression>((#DString_Write_VIN==17) or (#DString_Write_VIN==8)) and DString_C131_Car_Tpye~=""</Expression></Transition>
