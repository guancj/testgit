...
<Script></Script></End>
<Activities>
<Activity id="3" ActivityType="3" flags="0" name="11 01">
<Rect left="55" top="179" right="155" bottom="211"/>
<Line1Text Enable="1" Text="ECU 重置"/>
<Script>engine.SetRequestByte(0,0x11)
...
<Script>vciHandl1 = engine.EcuOpen()
engine.println("vciHandl1="..vciHandl1)
--engine.println("功能寻址开始，重启总线ECU，Stop_Flag="..engine.SharedVarGet(Stop_Flag))</Script></Activity>
<Activity id="5" ActivityType="3" flags="0" name="结束通讯">
<Rect left="56" top="240" right="156" bottom="272"/>
<Script>engine.EcuClose(vciHandl1)
--engine.println("功能寻址退出，Stop_Flag="..engine.SharedVarGet(Stop_Flag))</Script></Activity>
</Activities>
<Transitions>
