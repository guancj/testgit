...
<Process flags="1" block="1" ptbtext="DEP164" group="1063" pbltext="DEP1212">
<Parameters>
...
<Rect left="1390" top="545" right="1490" bottom="577"/>
<Script>#STOPCOMM
</Script></End>
<Activities>
...
Deal_hex_file(".\\Flash\\Fls_drv.hex",0,1);   
...
<ButtonLText Enable="1"/>
<ButtonRText Enable="1"/>
<Script>Deal_hex_file(".\\Flash\\CAL.hex",1,1);        </Script></Activity>
...
<ButtonLText Enable="1"/>
<ButtonRText Enable="1"/>
<Script>Deal_hex_file(".\\Flash\\BSW.HEX",1,1);      </Script></Activity>
...
<ButtonLText Enable="1"/>
<ButtonRText Enable="1"/>
<Script>Deal_hex_file(".\\Flash\\ASW.HEX",1,1);        </Script></Activity>
...
--engine.println("改动共享变量后，Stop_Flag="..engine.SharedVarGet(Stop_Flag));</Script></Activity>
<Activity id="127" ActivityType="3" flags="0" name="测试">
<Rect left="1" top="402" right="101" bottom="434"/>
...
<ButtonLText Enable="1"/>
<ButtonRText Enable="1"/>
<Script>Deal_hex_file(".\\Flash\\FSM.hex",1,1);         </Script></Activity>
...
<Activity id="130" ActivityType="3" flags="0" name="FunctionCAN">
<Variables>
<Variable id="ProtocolType" type="3" data="1" description="通讯协议"/>
...
<Rect left="2" top="320" right="102" bottom="352"/>
<Script>vciHandl1 = engine.EcuOpen()</Script></Activity>
...
<Rect left="906" top="491" right="1006" bottom="523"/>
...
<Activity id="136" ActivityType="3" flags="0" name="ECU 重置 7s">
<Rect left="1072" top="590" right="1172" bottom="622"/>
<Line1Text Enable="1" Text="ECU 重置"/>
<Line2Text Enable="1" Text="7秒"/>
<Line3Text Enable="1"/>
<Line4Text Enable="1"/>
<Script>#DELAY 7000</Script></Activity>
...
<Line1Text Enable="1" Text="通讯失败，请确保插头后重试"/>
<Line2Text Enable="1" Text="重试么？"/>
<ButtonLText Enable="1" Text="放弃连接"/>
<ButtonRText Enable="1" Text="重新连接"/>
<Script>engine.TestResult = 1;
...
<Rect left="156" top="63" right="256" bottom="95"/>
...
<Activity id="152" ActivityType="5" flags="0" name="Functional_Addressing_CloseAllECUComm">
<Rect left="618" top="302" right="718" bottom="334"/>
<SubProcesses>
<SubProcess id="Functional_Addressing_CloseAllECUComm">
<Parameters>
...
<Activity id="153" ActivityType="5" flags="0" name="Functional_Addressing_ResetAllECU">
<Rect left="1072" top="485" right="1172" bottom="517"/>
<SubProcesses>
<SubProcess id="Functional_Addressing_ResetAllECU">
<Parameters>
<Parameter id="Stop_Flag" value="Stop_Flag"/>
</Parameters>
</SubProcess>
...
<Transition StartId="112" EndId="152" type="0">
</Transition>
...
<Transition StartId="116" EndId="153" type="0">
</Transition>
...
<Transition StartId="152" EndId="103" type="0">
</Transition>
<Transition StartId="153" EndId="135" type="0">
</Transition>
</Transitions>
</Process>
