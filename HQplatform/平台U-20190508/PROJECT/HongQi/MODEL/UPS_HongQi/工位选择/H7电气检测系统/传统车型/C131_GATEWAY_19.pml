...
<Parameters>
<Variable id="C131_GATEWAY_VIN_Execute_Flag" type="11" dir="0" data=""/>
<Variable id="C131_GATEWAY_EID_Execute_Flag" type="11" dir="0" data=""/>
<Variable id="C131_GATEWAY_WD_Execute_Flag" type="11" dir="0" data=""/>
...
--[[
	...
	StringRes = engine.GetResponseString(0,engine.GetResponseSize());
	engine.StatValue=hexstr(StringRes);
end</Script><assessment no="1" name="DEP322" type="8" flags="97"/>
</Activity>
...
local StringRes;
StringRes = engine.GetResponseString(0,engine.GetResponseSize());
engine.StatValue=hexstr(StringRes);</Script><assessment no="2" name="DEP323" type="8" flags="97"/>
</Activity>
...
local StringRes;
StringRes = engine.GetResponseString(0,engine.GetResponseSize());
engine.StatValue=hexstr(StringRes);</Script><assessment no="3" name="DEP324" type="8" flags="97"/>
</Activity>
...
local StringRes;
StringRes = engine.GetResponseString(0,engine.GetResponseSize());
engine.StatValue=hexstr(StringRes);</Script><assessment no="4" name="DEP325" type="8" flags="97"/>
</Activity>
...
<Rect left="760" top="84" right="860" bottom="116"/>
...
</Script><assessment no="5" name="DEP326" type="8" flags="97"/>
</Activity>
...
<Rect left="794" top="34" right="826" bottom="66"/>
</Activity>
<Activity id="241" ActivityType="3" flags="0" name="发送VIN">
<Rect left="900" top="84" right="1000" bottom="116"/>
...
<Rect left="900" top="134" right="1000" bottom="166"/>
...
<Rect left="1040" top="134" right="1140" bottom="166"/>
<Line1Text Enable="1"/>
<Line2Text Enable="1"/>
<Line3Text Enable="1"/>
<Line4Text Enable="1"/>
...
<Rect left="1040" top="84" right="1140" bottom="116"/>
...
<Rect left="934" top="34" right="966" bottom="66"/>
</Activity>
...
<Rect left="1499" top="607" right="1599" bottom="639"/>
<Line1Text Enable="1"/>
<Line2Text Enable="1"/>
<Line3Text Enable="1"/>
<Line4Text Enable="1"/>
...
<Rect left="1224" top="34" right="1256" bottom="66"/>
</Activity>
<Activity id="256" ActivityType="4" flags="0" name="路由节点">
<Rect left="1074" top="34" right="1106" bottom="66"/>
</Activity>
<Activity id="259" ActivityType="3" flags="0" name="写0101">
<Rect left="1190" top="94" right="1290" bottom="126"/>
...
<Rect left="1320" top="94" right="1420" bottom="126"/>
<Line1Text Enable="1" Text="比对配置码"/>
<Script>#COMM 0x22 0x01 0x01
engine.println("配置码0101标准值:"..DString_C131_VariCoding0101);
if(@0==0x62)then
	DString_Read_Config_Code_From_ECU = engine.GetResponseString(3,2+#DString_Partnumber);
...
<Rect left="1190" top="134" right="1290" bottom="166"/>
<Line1Text Enable="1"/>
<Line2Text Enable="1"/>
<Line3Text Enable="1"/>
<Line4Text Enable="1"/>
...
<Rect left="1354" top="34" right="1386" bottom="66"/>
</Activity>
...
<Rect left="900" top="194" right="1000" bottom="226"/>
...
<Rect left="1600" top="94" right="1700" bottom="126"/>
<Line1Text Enable="1" Text="比对配置码"/>
...
<Rect left="1634" top="34" right="1666" bottom="66"/>
</Activity>
...
<Expression>DString_C131_Car_Tpye~="CH1LM21" and DString_C131_Car_Tpye~="CH1LM11" and DString_C131_Car_Tpye~="CH1MM21" and CarTNC_Isnot_Hrid(DString_C131_Car_Tpye)</Expression></Transition>
...
<Transition StartId="214" EndId="213" type="0">
</Transition>
...
<Transition StartId="219" EndId="229" type="0">
</Transition>
...
<Transition StartId="240" EndId="236" type="0">
</Transition>
...
<Transition StartId="248" EndId="202" type="0">
</Transition>
...
<Transition StartId="377" EndId="248" type="0">
</Transition>
</Transitions>
</Process>
