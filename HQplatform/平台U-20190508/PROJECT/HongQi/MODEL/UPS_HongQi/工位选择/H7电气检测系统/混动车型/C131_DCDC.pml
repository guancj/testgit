...
<Process flags="1" block="1" ptbtext="DEP164" group="1141" pbltext="DEP847">
<Parameters>
...
<Variable id="C131_DCDC_OEM_Execute_Flag" type="11" dir="0" data="true"/>
<Variable id="C131_DCDC_SN_Execute_Flag" type="11" dir="0" data="true"/>
<Variable id="C131_DCDC_SVP_Execute_Flag" type="11" dir="0" data="true"/>
<Variable id="C131_DCDC_VIN_Execute_Flag" type="11" dir="0" data="true"/>
<Variable id="C131_DCDC_EID_Execute_Flag" type="11" dir="0" data="true"/>
<Variable id="C131_DCDC_WD_Execute_Flag" type="11" dir="0" data="true"/>
<Variable id="DString_C131_Car_Tpye" type="8" dir="0" data="DString_C131_Car_Tpye"/>
<Variable id="C131_MCU_CheckDCDC_Execute_Flag" type="11" dir="0" data="false"/>
...
<Activities>
<Activity id="3" ActivityType="3" flags="0" name="DC/DC (DCDC)">
<Rect left="343" top="55" right="443" bottom="87"/>
<TitleText Enable="1" Text="DC/DC (DCDC)"/>
...
</Script><assessment no="2" name="DEP849" type="8" flags="97"/>
</Activity>
...
<Rect left="340" top="303" right="440" bottom="335"/>
<Script>#COMM 0x10 0x03

local StringRes;
StringRes = engine.GetResponseString(0,engine.GetResponseSize());
engine.StatValue=hexstr(StringRes);</Script><assessment no="33" name="DEP1110" type="8" flags="97"/>
</Activity>
<Activity id="7" ActivityType="3" flags="0" name="安全访问种子">
<Rect left="339" top="357" right="439" bottom="389"/>
...
StringRes = engine.GetResponseString(0,engine.GetResponseSize());
engine.StatValue=hexstr(StringRes);
</Script><assessment no="3" name="DEP1043" type="8" flags="97"/>
</Activity>
<Activity id="8" ActivityType="3" flags="0" name="发送key">
<Rect left="339" top="449" right="439" bottom="481"/>
<Line1Text Enable="1"/>
...
StringRes = engine.GetResponseString(0,engine.GetResponseSize());
engine.StatValue=hexstr(StringRes);
</Script><assessment no="13" name="DEP1044" type="8" flags="97"/>
</Activity>
...
--[[
	...
	StringRes = engine.GetResponseString(0,engine.GetResponseSize());
	engine.StatValue=hexstr(StringRes);
end</Script><assessment no="4" name="DEP851" type="8" flags="97"/>
</Activity>
...
<Rect left="656" top="12" right="688" bottom="44"/>
</Activity>
<Activity id="15" ActivityType="3" flags="0" name="读软件号">
<Rect left="623" top="65" right="723" bottom="97"/>
...
StringRes = engine.GetResponseString(0,engine.GetResponseSize());
engine.StatValue=hexstr(StringRes);
</Script><assessment no="5" name="DEP852" type="8" flags="97"/>
</Activity>
<Activity id="16" ActivityType="3" flags="0" name="延时300MS">
<Rect left="622" top="113" right="722" bottom="145"/>
<Line1Text Enable="1"/>
<Script>#DELAY  300</Script></Activity>
<Activity id="17" ActivityType="3" flags="0" name="读软件版本号">
<Rect left="767" top="65" right="867" bottom="97"/>
<Line1Text Enable="1" Text="读软件版本号"/>
<Script>#COMM 0x22 0xF1 0x95
StandValue="30333035303030303030";
...
if(@0==0x62)then
	...
	StringRes = engine.GetResponseString(0,engine.GetResponseSize());
	engine.StatValue=hexstr(StringRes);
end</Script><assessment no="6" name="DEP853" type="8" flags="97"/>
</Activity>
<Activity id="18" ActivityType="3" flags="0" name="延时300MS">
<Rect left="768" top="114" right="868" bottom="146"/>
<Line1Text Enable="1"/>
<Line2Text Enable="1"/>
<Line3Text Enable="1"/>
<Line4Text Enable="1"/>
...
<Rect left="802" top="12" right="834" bottom="44"/>
</Activity>
<Activity id="20" ActivityType="3" flags="0" name="发送VIN">
<Rect left="908" top="68" right="1008" bottom="100"/>
...
local StringRes;
StringRes = engine.GetResponseString(0,engine.GetResponseSize());
engine.StatValue=hexstr(StringRes);</Script><assessment no="7" name="DEP854" type="8" flags="97"/>
</Activity>
<Activity id="21" ActivityType="3" flags="0" name="读VIN">
<Rect left="908" top="170" right="1008" bottom="202"/>
...
if(@0==0x62)then
	...
	StringRes = engine.GetResponseString(0,engine.GetResponseSize());
	engine.StatValue=hexstr(StringRes);
end</Script><assessment no="8" name="DEP855" type="8" flags="97"/>
</Activity>
<Activity id="22" ActivityType="3" flags="0" name="日期读取">
<Rect left="1061" top="166" right="1161" bottom="198"/>
...
<Rect left="1062" top="67" right="1162" bottom="99"/>
...
<Rect left="942" top="11" right="974" bottom="43"/>
</Activity>
<Activity id="26" ActivityType="3" flags="0" name="延时300ms">
<Rect left="1229" top="124" right="1329" bottom="156"/>
<Line1Text Enable="1"/>
<Script>#DELAY 300</Script></Activity>
<Activity id="27" ActivityType="3" flags="0" name="检查配置码">
<Rect left="1346" top="63" right="1446" bottom="95"/>
...
if(@0==0x62)then
	...
	StringRes = engine.GetResponseString(0,engine.GetResponseSize());
	engine.StatValue=hexstr(StringRes);
end</Script><assessment no="12" name="DEP857" type="8" flags="97"/>
</Activity>
<Activity id="28" ActivityType="3" flags="0" name="写配置码">
<Rect left="1229" top="64" right="1329" bottom="96"/>
...
local StringRes;
StringRes = engine.GetResponseString(0,engine.GetResponseSize());
engine.StatValue=hexstr(StringRes);</Script><assessment no="11" name="DEP856" type="8" flags="97"/>
</Activity>
<Activity id="29" ActivityType="4" flags="0" name="路由节点">
<Rect left="1262" top="9" right="1294" bottom="41"/>
</Activity>
<Activity id="30" ActivityType="4" flags="0" name="路由节点">
<Rect left="1097" top="10" right="1129" bottom="42"/>
</Activity>
<Activity id="31" ActivityType="4" flags="0" name="路由节点">
<Rect left="1381" top="10" right="1413" bottom="42"/>
</Activity>
...
<Rect left="907" top="120" right="1007" bottom="152"/>
<Line1Text Enable="1"/>
<Script>#DELAY  300</Script></Activity>
<Activity id="38" ActivityType="3" flags="0" name="延时300MS">
<Rect left="1061" top="117" right="1161" bottom="149"/>
<Line1Text Enable="1"/>
<Script>#DELAY  300</Script></Activity>
<Activity id="71" ActivityType="13" flags="0" name="seedtokey">
<Rect left="340" top="401" right="440" bottom="433"/>
...
<Parameter id="p_mask" value="0x5B8A8A7D"/>
</Parameters>
</FunctionRef>
</Activity>
<Activity id="72" ActivityType="3" flags="1" name="通讯">
...
local StringRes;
StringRes = engine.GetResponseString(0,engine.GetResponseSize());
engine.StatValue=hexstr(StringRes);</Script><assessment no="1" name="DEP848" type="8" flags="97"/>
</Activity>
<Activity id="73" ActivityType="3" flags="0" name="通讯失败">
<Rect left="225" top="150" right="325" bottom="182"/>
<Line1Text Enable="1" Text="DCDC 控制器连接失败！"/>
...
<Rect left="1488" top="9" right="1520" bottom="41"/>
</Activity>
<Activity id="77" ActivityType="4" flags="0" name="路由节点">
<Rect left="258" top="502" right="290" bottom="534"/>
</Activity>
<Activity id="78" ActivityType="3" flags="0" name="普通节点">
<Rect left="341" top="246" right="441" bottom="278"/>
<Line1Text Enable="1" Text="延迟2.5秒后，进行安全访问"/>
<Script>#DELAY 2500
</Script></Activity>
</Activities>
<Transitions>
...
<Transition StartId="4" EndId="78" type="0">
</Transition>
...
<Expression>C131_DCDC_OEM_Execute_Flag == true</Expression></Transition>
<Transition StartId="13" EndId="14" type="0">
</Transition>
<Transition StartId="14" EndId="15" type="1">
<Expression>C131_DCDC_SN_Execute_Flag == true</Expression></Transition>
...
<Expression>C131_DCDC_SVP_Execute_Flag == true</Expression></Transition>
...
<Expression>C131_DCDC_VIN_Execute_Flag == true</Expression></Transition>
<Transition StartId="24" EndId="30" type="0">
</Transition>
<Transition StartId="26" EndId="31" type="0">
</Transition>
<Transition StartId="27" EndId="76" type="0">
</Transition>
<Transition StartId="28" EndId="26" type="0">
</Transition>
<Transition StartId="29" EndId="28" type="1">
<Expression>C131_DCDC_WD_Execute_Flag==true and DString_C131_VariCoding ~= "" and DString_C131_VariCoding~="DCDC0_varicoding" and VMTLOC ~= "RIN"</Expression></Transition>
<Transition StartId="29" EndId="31" type="0">
</Transition>
<Transition StartId="30" EndId="23" type="1">
<Expression>C131_DCDC_EID_Execute_Flag ==true</Expression></Transition>
<Transition StartId="30" EndId="29" type="0">
</Transition>
<Transition StartId="31" EndId="27" type="1">
<Expression>(C131_DCDC_WD_Execute_Flag==true or VMTLOC=="FIN") and DString_C131_VariCoding ~= "" and DString_C131_VariCoding~="DCDC0_varicoding"</Expression></Transition>
<Transition StartId="31" EndId="76" type="0">
</Transition>
...
<Transition StartId="76" EndId="36" type="0">
</Transition>
<Transition StartId="77" EndId="36" type="0">
</Transition>
<Transition StartId="78" EndId="6" type="0">
</Transition>
</Transitions>
</Process>
