...
<Process flags="1" block="1" ptbtext="DEP164" group="1060" pbltext="DEP1212">
<Parameters>
...
Deal_hex_file(".\\Flash\\Fls_drv.hex",0);   
...
<Line1Text Enable="1" Text="连接ECU，请于2S内上电"/>
<Line2Text Enable="1"/>
<ButtonLText Enable="1"/>
<ButtonRText Enable="1"/>
...
s1=@3
s2=@4
s3=@5</Script><assessment block="1" ptbtext="DEP164" no="1" name="DEP1213" type="8" flags="97"/>
</Activity>
...
<Rect left="346" top="305" right="446" bottom="337"/>
<Line1Text Enable="1" Text="通讯中"/>
<Line2Text Enable="1"/>
<Line3Text Enable="1"/>
<Line4Text Enable="1"/>
...
engine.println("改动共享变量后，Stop_Flag="..engine.SharedVarGet(Stop_Flag));</Script></Activity>
<Activity id="126" ActivityType="3" flags="0" name="抢占通道会话02">
<Rect top="244" right="100" bottom="276"/>
<Strategy TotalTime="100" NokTime="0" RetryTimeOut="8"/>
<Line1Text Enable="1" Text="抢占通道02"/>
<Line2Text Enable="1"/>
<Line3Text Enable="1"/>
<Line4Text Enable="1"/>
<InputText Enable="1"/>
...
<ButtonLText Enable="1"/>
<ButtonRText Enable="1"/>
<Script>Deal_hex_file(".\\Flash\\FSM.hex",1);         </Script></Activity>
...
<Script>engine.println("重新连接HCU，读版本信息");
#COMM 0x22 0xf1 0x87
...
<Rect left="1074" top="744" right="1174" bottom="776"/>
...
if("xxHPHEV041BC0201" == DString1)then
    engine.LastError = 0;
    engine.println("比软件版本号成功"..DString1.."  xxHPHEV041BC0201");
    engine.StatValue=DString1;
engine.SetLineText(1,"版本信息正确，刷写成功");
engine.SetLineText(2,DString1);
engine.SetLineText(3,"xxHPHEV041BC0201");
#DELAY 2000
else 
    engine.LastError = 1;
    engine.TestResult = 1;
    engine.println("比对软件版本号失败"..DString1.."  xxHPHEV041BC0201");
    engine.StatValue=DString1;
    engine.StatPoint="xxHPHEV041BC0201";
...
<Line1Text Enable="1" Text="通讯失败，请重新连接"/>
<Line2Text Enable="1" Text="重试么？"/>
<ButtonLText Enable="1" Text="放弃连接"/>
<ButtonRText Enable="1" Text="重新连接"/>
<Script>engine.TestResult = 1;
...
<Rect left="155" top="86" right="255" bottom="118"/>
...
<Transition StartId="138" EndId="142" type="3">
</Transition>
