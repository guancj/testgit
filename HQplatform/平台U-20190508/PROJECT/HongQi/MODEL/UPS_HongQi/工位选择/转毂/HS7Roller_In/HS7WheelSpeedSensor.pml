...
<Rect left="230" top="3274" right="330" bottom="3306"/>
...
<Rect left="230" top="3014" right="330" bottom="3046"/>
...
<Rect left="230" top="134" right="330" bottom="166"/>
...
<Activity id="306" ActivityType="13" flags="0" name="禁用速度限制">
...
<Parameter id="sendTel" value="&apos;\x01\xDF\x46\x00&apos;"/>
<Parameter id="recvTel" ret="DVciResult"/>
</Parameters>
</FunctionRef>
...
<Activity id="1238" ActivityType="13" flags="0" name="UDS_ReadDTCByStatusMask">
...
<Activity id="1239" ActivityType="13" flags="0" name="UDS_DTCFilterStatisticList">
...
<assessment no="12" name="DEP148" type="8" flags="97"/>
</Activity>
<Activity id="1240" ActivityType="3" flags="0" name="检测系统状态评估">
<Rect left="230" top="1184" right="330" bottom="1216"/>
<Script>DVciResult = string.sub(DVciResult1,4,4);
DVciResult = LibGeneral.hex2str(DVciResult)
engine.println("### 抽真空加注字节FD03 ##"..DVciResult);</Script></Activity>
<Activity id="1241" ActivityType="13" flags="0" name="抽真空加注过程比对">
<Rect left="230" top="1244" right="330" bottom="1276"/>
...
<Activity id="1242" ActivityType="3" flags="0" name="LoopEnd">
<Rect left="230" top="1294" right="330" bottom="1326"/>
<Script></Script></Activity>
<Activity id="1243" ActivityType="4" flags="0" name="路由节点">
<Rect left="394" top="1194" right="426" bottom="1226"/>
</Activity>
<Activity id="1244" ActivityType="13" flags="0" name="读取抽真空加注过程字节">
<Rect left="230" top="1124" right="330" bottom="1156"/>
<FunctionRef id="ECU_DataExchange" model="LibGeneral">
<Parameters>
<Parameter id="ECU_Handle" value="vciHandle"/>
<Parameter id="reqTitle" value="0x22"/>
<Parameter id="resTitle" value="0x62"/>
<Parameter id="sendTel" value="&apos;\x17\xA3&apos;"/>
<Parameter id="recvTel" ret="DVciResult1"/>
</Parameters>
</FunctionRef>
</Activity>
<Activity id="1245" ActivityType="3" flags="0" name="InitTest">
<Rect left="230" top="1064" right="330" bottom="1096"/>
<Line2Text Enable="1"/>
<Script>Pram_1 = nil;</Script></Activity>
<Activity id="1246" ActivityType="3" flags="0" name="故障取消">
<Rect left="370" top="1004" right="470" bottom="1036"/>
<Line1Text Enable="1" Text="车辆请停止！"/>
<Line2Text Enable="1"/>
<Line3Text Enable="1" Text="控制器存在故障,检测取消！"/>
...
<Activity id="1253" ActivityType="13" flags="0" name="ECU_Close">
...
<Parameter id="reqTitle" value="0x31"/>
<Parameter id="resTitle" value="0x71"/>
<Parameter id="sendTel" value="&apos;\x01\xDF\x44\x01\x2C&apos;"/>
<Parameter id="recvTel" ret="DVciResult"/>
</Parameters>
</FunctionRef>
...
DVciResult = LibGeneral.hex2str(DVciResult)
engine.println("### 读取轮速 3103DF44 ##"..DVciResult);</Script></Activity>
...
<assessment no="18" name="DEP1519" type="8" flags="97"/>
</Activity>
...
<Parameter id="reqTitle" value="0x31"/>
<Parameter id="resTitle" value="0x71"/>
<Parameter id="sendTel" value="&apos;\x03\xDF\x44&apos;"/>
...
<Activity id="1290" ActivityType="3" flags="0" name="显示等待">
<Rect left="440" top="2604" right="540" bottom="2636"/>
<Script>engine.Delay(1000)</Script></Activity>
<Activity id="1292" ActivityType="13" flags="0" name="ECU_Close">
<Rect left="230" top="2944" right="330" bottom="2976"/>
<FunctionRef id="ECU_Close" model="LibGeneral">
<Parameters>
<Parameter id="ECU_Handle" value="vciHandle"/>
</Parameters>
...
<Rect left="230" top="3084" right="330" bottom="3116"/>
<SubProcesses>
<SubProcess id="RTS_03_ControlActuators">
<Parameters>
...
<Rect left="230" top="3204" right="330" bottom="3236"/>
<Script>local brk = 0
local TimeStart = os.time();
local TimeDiff
local curtRevTel
...
<Activity id="1306" ActivityType="13" flags="0" name="ECU_Close">
...
<Rect left="370" top="3084" right="470" bottom="3116"/>
<Script>isOK = 3
engine.LastError = 1
...
<Rect left="230" top="3144" right="330" bottom="3176"/>
<Script>engine.LastError = 0
...
<Rect left="230" top="2604" right="330" bottom="2636"/>
<FunctionRef id="FloatToleranceCheck" model="LibGeneral">
<Parameters>
...
<Rect left="230" top="2664" right="330" bottom="2696"/>
<FunctionRef id="FloatToleranceCheck" model="LibGeneral">
<Parameters>
...
<Rect left="230" top="2724" right="330" bottom="2756"/>
<FunctionRef id="FloatToleranceCheck" model="LibGeneral">
<Parameters>
...
<Rect left="230" top="2784" right="330" bottom="2816"/>
<FunctionRef id="FloatToleranceCheck" model="LibGeneral">
<Parameters>
<Parameter id="ActualValue" value="SpeedRR_Max"/>
<Parameter id="Utg" value="10.8"/>
...
<Activity id="1325" ActivityType="5" flags="0" name="HS7_AT_ReadN">
<Rect left="650" top="124" right="750" bottom="156"/>
<SubProcesses>
<SubProcess id="HS7_AT_ReadN">
</SubProcess>
</SubProcesses>
</Activity>
<Activity id="1326" ActivityType="13" flags="0" name="安全访问">
...
<Activity id="1327" ActivityType="13" flags="0" name="激活速度限制">
<Rect left="230" top="2864" right="330" bottom="2896"/>
<FunctionRef id="ECU_DataExchange" model="LibGeneral">
<Parameters>
<Parameter id="ECU_Handle" value="vciHandle"/>
<Parameter id="reqTitle" value="0x31"/>
<Parameter id="resTitle" value="0x71"/>
<Parameter id="sendTel" value="&apos;\x01\xDF\x46\x01&apos;"/>
<Parameter id="recvTel" ret="DVciResult"/>
</Parameters>
</FunctionRef>
<assessment no="4" name="DEP1510" type="8" flags="97"/>
...
<Rect left="84" top="1184" right="116" bottom="1216"/>
</Activity>
</Activities>
<Transitions>
...
<Transition StartId="23" EndId="1326" type="0">
</Transition>
<Transition StartId="23" EndId="1305" type="4">
</Transition>
<Transition StartId="306" EndId="1227" type="3">
</Transition>
...
<Transition StartId="1237" EndId="1328" type="0">
</Transition>
...
<Transition StartId="1242" EndId="1253" type="4">
</Transition>
<Transition StartId="1242" EndId="1248" type="0">
</Transition>
<Transition StartId="1243" EndId="1244" type="0">
</Transition>
<Transition StartId="1244" EndId="1240" type="0">
</Transition>
<Transition StartId="1245" EndId="1244" type="0">
</Transition>
<Transition StartId="1246" EndId="1306" type="0">
</Transition>
...
<Transition StartId="1290" EndId="1319" type="0">
</Transition>
...
<Transition StartId="1302" EndId="22" type="0">
</Transition>
...
<Transition StartId="1323" EndId="1327" type="0">
</Transition>
<Transition StartId="1326" EndId="306" type="0">
</Transition>
<Transition StartId="1327" EndId="1292" type="0">
</Transition>
<Transition StartId="1328" EndId="1248" type="0">
</Transition>
</Transitions>
</Process>
