...
<Activity id="9" ActivityType="3" name="速度检查">
<Rect left="455" top="380" right="555" bottom="412"/>
<Script>if(Speed_FA &gt;= Target_Min and Speed_FA &lt;= Target_Max) then
 LoopRunning = false;
 Result = 0;
else
 engine.Delay(50);
end
engine.println("##### Speed : " .. Speed_FA .. "\n");
</Script></Activity>
...
<Activity id="19" ActivityType="13" name="读取转毂速度">
