...
end</Script><assessment no="6" name="DEP378" type="8" flags="105"/>
</Activity>
<Activity id="164" ActivityType="3" flags="0" name="读硬件版本号">
<Rect left="1110" top="314" right="1210" bottom="346"/>
...
local StringRes;
StringRes = engine.GetResponseString(0,engine.GetResponseSize());
engine.StatValue=hexstr(StringRes);</Script><assessment no="8" name="DEP380" type="8" flags="97"/>
</Activity>
...
engine.StatPoint = SoftwareNumber;</Script><assessment no="10" name="DEP382" type="8" flags="105"/>
</Activity>
...
if(@0==0x62)then
	...
	StringRes = engine.GetResponseString(0,engine.GetResponseSize());
	engine.StatValue=hexstr(StringRes);
end</Script><assessment no="12" name="DEP384" type="8" flags="105"/>
</Activity>
<Activity id="176" ActivityType="3" flags="1" name="日期读取">
...
<Rect left="90" top="324" right="190" bottom="356"/>
...
<Rect left="1110" top="394" right="1210" bottom="426"/>
...
<Rect left="1110" top="554" right="1210" bottom="586"/>
...
<Activity id="199" ActivityType="5" flags="0" name="SCM_ReadDTC">
<Rect left="220" top="654" right="320" bottom="686"/>
<SubProcesses>
...
<Activity id="202" ActivityType="3" flags="0" name="清DTC">
<Rect left="90" top="244" right="190" bottom="276"/>
<Line1Text Enable="1"/>
...
<Rect left="344" top="704" right="376" bottom="736"/>
</Activity>
</Activities>
<Transitions>
...
<Transition StartId="191" EndId="3" type="0">
</Transition>
...
<Transition StartId="195" EndId="202" type="0">
</Transition>
<Transition StartId="196" EndId="197" type="0">
</Transition>
<Transition StartId="196" EndId="420" type="5">
</Transition>
<Transition StartId="197" EndId="190" type="0">
</Transition>
<Transition StartId="199" EndId="2" type="0">
</Transition>
<Transition StartId="202" EndId="191" type="0">
</Transition>
