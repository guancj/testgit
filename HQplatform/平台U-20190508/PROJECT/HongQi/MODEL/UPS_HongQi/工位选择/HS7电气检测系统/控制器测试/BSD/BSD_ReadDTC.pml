...
<Script></Script><TitleText Enable="1" Text="BSD(并线辅助)"/>
</Start>
...
<assessment no="15" name="DEP887" type="8" flags="97"/>
</Activity>
...
<assessment no="16" name="DEP2072" type="8" flags="97"/>
</Activity>
<Activity id="175" ActivityType="4" flags="0" name="路由节点">
<Rect left="494" top="464" right="526" bottom="496"/>
</Activity>
...
<Rect left="1040" top="194" right="1140" bottom="226"/>
...
engine.StatValue=hexstr(StringRes);</Script><assessment no="20" name="DEP870" type="8" flags="97"/>
</Activity>
<Activity id="179" ActivityType="3" flags="0" name="通讯失败">
<Rect left="850" top="194" right="950" bottom="226"/>
...
<Rect left="850" top="154" right="950" bottom="186"/>
<Script>#STOPCOMM
</Script></Activity>
...
<Rect left="600" top="204" right="700" bottom="236"/>
...
<assessment no="20" name="DEP870" type="8" flags="97"/>
</Activity>
...
<Rect left="730" top="334" right="830" bottom="366"/>
<FunctionRef id="UDS_DTCFilterStatisticList" model="LibGeneral">
<Parameters>
<Parameter id="UDS_DTC_CODE" value="aDTC_Tab_pCode"/>
<Parameter id="Filter_Pcode" value="{&quot;B16C354&quot;}"/>
<Parameter id="ViewList_Flag" value="false"/>
<Parameter id="Timeout" value="0"/>
<Parameter id="section" value="&quot;C079_BSD&quot;"/>
<Parameter id="DTC_Table_list_Pcode" ret="aPcode"/>
...
<Transition StartId="185" EndId="4" type="3">
</Transition>
