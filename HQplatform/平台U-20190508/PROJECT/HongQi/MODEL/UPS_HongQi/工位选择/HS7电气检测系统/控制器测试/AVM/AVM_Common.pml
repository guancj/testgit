...
<Rect left="450" top="54" right="550" bottom="86"/>
<Script></Script></Start>
...
<Rect left="710" top="664" right="810" bottom="696"/>
...
<Rect left="450" top="314" right="550" bottom="346"/>
...
<Rect left="450" top="354" right="550" bottom="386"/>
...
<Rect left="450" top="464" right="550" bottom="496"/>
<Line1Text Enable="1"/>
<Line2Text Enable="1"/>
<Line3Text Enable="1"/>
<Line4Text Enable="1"/>
...
<Rect left="250" top="214" right="350" bottom="246"/>
...
engine.StatPoint = DString_Partnumber;</Script><assessment no="6" name="DEP1699" type="8" flags="97"/>
</Activity>
...
<Activity id="105" ActivityType="3" flags="0" name="发送VIN">
...
StringRes = @0-;
engine.StatValue=hexstr(StringRes);
end </Script><assessment no="11" name="DEP1704" type="8" flags="97"/>
</Activity>
...
if(@0==0x62)then
	...
	StringRes = engine.GetResponseString(0,engine.GetResponseSize());
	engine.StatValue=hexstr(StringRes);
end</Script><assessment no="12" name="DEP1705" type="8" flags="97"/>
</Activity>
...
<Rect left="1004" top="634" right="1036" bottom="666"/>
</Activity>
<Activity id="115" ActivityType="3" flags="0" name="读软件版本号">
...
elseif(LibGeneral.CarTNC_HS7_H(engine.CarType) == true)then
	...
	StringRes = engine.GetResponseString(0,engine.GetResponseSize());
	engine.StatValue=hexstr(StringRes);
end</Script><assessment no="10" name="DEP1703" type="8" flags="97"/>
</Activity>
<Activity id="116" ActivityType="3" flags="0" name="清DTC">
<Rect left="450" top="264" right="550" bottom="296"/>
<Line1Text Enable="1"/>
...
<Transition StartId="10" EndId="14" type="0">
</Transition>
...
<Transition StartId="14" EndId="115" type="0">
</Transition>
<Transition StartId="104" EndId="105" type="1">
...
<Transition StartId="115" EndId="104" type="0">
</Transition>
