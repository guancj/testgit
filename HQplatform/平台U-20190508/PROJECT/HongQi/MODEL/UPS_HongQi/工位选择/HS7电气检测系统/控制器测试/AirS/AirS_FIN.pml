...
<Rect left="80" right="180" bottom="32"/>
<Script></Script></Start>
<End id="2" ActivityType="2" flags="0" name="结束节点">
<Rect left="80" top="824" right="180" bottom="856"/>
...
<Activities>
<Activity id="3" ActivityType="3" flags="0" name="空气悬架(AirS)">
...
<Rect left="80" top="364" right="180" bottom="396"/>
...
<Rect left="380" top="444" right="480" bottom="476"/>
...
<Rect left="380" top="524" right="480" bottom="556"/>
<Line1Text Enable="1"/>
<Line2Text Enable="1"/>
<Line3Text Enable="1"/>
<Line4Text Enable="1"/>
...
#DELAY  50</Script><assessment no="5" name="DEP1668" type="8" flags="97"/>
</Activity>
<Activity id="11" ActivityType="3" flags="0" name="通讯">
<Rect left="80" top="194" right="180" bottom="226"/>
...
<Rect left="80" top="444" right="180" bottom="476"/>
...
#DELAY  50</Script><assessment no="6" name="DEP1669" type="8" flags="105"/>
</Activity>
...
StringRes = engine.GetResponseString(0,engine.GetResponseSize());
engine.StatValue=hexstr(StringRes);
#DELAY  50</Script><assessment no="8" name="DEP1671" type="8" flags="97"/>
</Activity>
...
engine.StatPoint = SoftwareNumber.."或"..SoftwareNumber1;</Script><assessment no="10" name="DEP1673" type="8" flags="105"/>
</Activity>
<Activity id="107" ActivityType="3" flags="0" name="检查VIN">
<Rect left="80" top="584" right="180" bottom="616"/>
...
#DELAY  50</Script><assessment no="12" name="DEP1675" type="8" flags="105"/>
</Activity>
<Activity id="108" ActivityType="3" flags="0" name="日期读取">
<Rect left="80" top="664" right="180" bottom="696"/>
<Line1Text Enable="1"/>
<Line2Text Enable="1"/>
<Line3Text Enable="1"/>
<Line4Text Enable="1"/>
...
<Rect left="80" top="744" right="180" bottom="776"/>
...
if(@0==0x62)then
	...
	StringRes = engine.GetResponseString(0,engine.GetResponseSize());
	engine.StatValue=hexstr(StringRes);
end</Script><assessment no="14" name="DEP1677" type="8" flags="105"/>
</Activity>
<Activity id="114" ActivityType="5" flags="0" name="AirSu_ReadDTC">
<Rect left="10" top="904" right="110" bottom="936"/>
<SubProcesses>
...
<Rect left="80" top="284" right="180" bottom="316"/>
<Line1Text Enable="1"/>
...
<Rect left="274" top="824" right="306" bottom="856"/>
</Activity>
</Activities>
<Transitions>
...
<Transition StartId="6" EndId="35" type="0">
</Transition>
...
<Transition StartId="11" EndId="117" type="0">
</Transition>
...
<Transition StartId="117" EndId="6" type="0">
</Transition>
