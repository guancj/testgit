...
<Parameters>
<Variable id="DString_Partnumber" type="8" dir="0" data="IFC_partnumber"/>
...
<Rect left="550" top="54" right="650" bottom="86"/>
<Script></Script></Start>
<End id="2" ActivityType="2" flags="0" name="结束节点">
<Rect left="430" top="664" right="530" bottom="696"/>
<Script>#STOPCOMM</Script></End>
<Activities>
<Activity id="3" ActivityType="3" flags="0" name="智能前视摄像头(IFC)">
<Rect left="550" top="114" right="650" bottom="146"/>
<TitleText Enable="1" Text="智能前视摄像头(IFC)"/>
<Script></Script></Activity>
<Activity id="4" ActivityType="3" flags="0" name="清DTC">
<Rect left="820" top="704" right="920" bottom="736"/>
<Line1Text Enable="1" Text="清除DTC"/>
<Script>#COMM 0x14 0xFF 0xFF 0xFF
local StringRes;
StringRes = engine.GetResponseString(0,engine.GetResponseSize());
engine.StatValue=hexstr(StringRes);
</Script><assessment no="2" name="DEP1710" type="8" flags="97"/>
</Activity>
...
StringRes = engine.GetResponseString(0,engine.GetResponseSize());
engine.StatValue=hexstr(StringRes);
</Script><assessment no="5" name="DEP1713" type="8" flags="97"/>
</Activity>
...
</Script><assessment no="1" name="DEP1709" type="8" flags="97"/>
</Activity>
<Activity id="90" ActivityType="3" flags="0" name="通讯失败">
<Rect left="430" top="214" right="530" bottom="246"/>
...
<Rect left="680" top="474" right="780" bottom="506"/>
...
engine.StatPoint = DString_Partnumber;</Script><assessment no="6" name="DEP1714" type="8" flags="97"/>
</Activity>
...
</Script><assessment no="10" name="DEP1718" type="8" flags="97"/>
</Activity>
<Activity id="173" ActivityType="3" flags="0" name="延时50MS">
<Rect left="820" top="524" right="920" bottom="556"/>
<Line1Text Enable="1"/>
<Line4Text Enable="1"/>
<Script>#DELAY  50</Script></Activity>
<Activity id="174" ActivityType="3" flags="0" name="发送VIN">
<Rect left="960" top="474" right="1060" bottom="506"/>
...
StringRes = @0-;
engine.StatValue=hexstr(StringRes);
end </Script><assessment no="11" name="DEP1719" type="8" flags="97"/>
</Activity>
<Activity id="175" ActivityType="3" flags="0" name="检查VIN">
<Rect left="960" top="524" right="1060" bottom="556"/>
...
if(@0==0x62)then
	...
	StringRes = engine.GetResponseString(0,engine.GetResponseSize());
	engine.StatValue=hexstr(StringRes);
end</Script><assessment no="12" name="DEP1720" type="8" flags="97"/>
</Activity>
<Activity id="176" ActivityType="3" flags="0" name="日期读取">
<Rect left="1080" top="524" right="1180" bottom="556"/>
<Line1Text Enable="1"/>
<Line2Text Enable="1"/>
<Line3Text Enable="1"/>
<Line4Text Enable="1"/>
...
<Rect left="1080" top="474" right="1180" bottom="506"/>
...
<Rect left="1320" top="474" right="1420" bottom="506"/>
...
if(@0==0x62)then
	...
	StringRes = engine.GetResponseString(0,engine.GetResponseSize());
	engine.StatValue=hexstr(StringRes);
end</Script><assessment no="14" name="DEP1722" type="8" flags="97"/>
</Activity>
<Activity id="181" ActivityType="3" flags="0" name="写配置码">
<Rect left="1190" top="474" right="1290" bottom="506"/>
...
end </Script><assessment no="13" name="DEP1721" type="8" flags="97"/>
</Activity>
<Activity id="182" ActivityType="4" flags="0" name="路由节点">
<Rect left="1354" top="664" right="1386" bottom="696"/>
</Activity>
<Activity id="183" ActivityType="3" flags="0" name="清DTC">
...
<Activity id="184" ActivityType="3" flags="0" name="清DTC">
<Rect left="960" top="664" right="1060" bottom="696"/>
<Line1Text Enable="1"/>
<Line2Text Enable="1" Text="清除DTC"/>
<Line3Text Enable="1"/>
<Line4Text Enable="1"/>
...
<Transition StartId="88" EndId="183" type="0">
</Transition>
...
<Transition StartId="181" EndId="178" type="0">
</Transition>
<Transition StartId="182" EndId="184" type="0">
</Transition>
<Transition StartId="183" EndId="6" type="0">
</Transition>
<Transition StartId="184" EndId="2" type="0">
</Transition>
</Transitions>
</Process>
